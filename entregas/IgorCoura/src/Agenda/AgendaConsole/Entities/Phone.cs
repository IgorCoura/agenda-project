...
namespace AgendaConsole.Entities
{
    public class Phone: Register
    {
        ...
        public Phone(int id, int contactId, string description, string formattedPhone, int dDD, int number, DateTime createdAt, DateTime updatedAt) : base(id, createdAt, updatedAt)
        {
            ContactId = contactId;
