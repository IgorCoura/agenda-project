...
//1.2
Console.WriteLine("\nDesafio 1.2");
Console.WriteLine(Desafios.CalcularPremio(100, "vip", null) == 120.00);//true
Console.WriteLine(Desafios.CalcularPremio(100, "basic", 3) == 300.00);//true
...
//1.9
Console.WriteLine("\nDesafio 1.9");
var expected19 = new int[][] { new int[] { 1, 2 }, new int[] { 3, 4 }, new int[] { 5, 6 } };
var result19 = Desafios.TransformarEmMatriz("1,2,3,4,5,6");
Console.WriteLine(verificarIgualdadeMatrizes(result19, expected19));
